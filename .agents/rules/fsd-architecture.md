...
description: Feature-Sliced Design (FSD) 2.1 architecture guidelines for Next.js App Router.
...
When developing features, decomposing layout, or generating code for the project, STRICTLY adhere to the Feature-Sliced Design (FSD) 2.1 methodology adapted for Next.js.
...
## 3. Technical Mapping for Next.js
