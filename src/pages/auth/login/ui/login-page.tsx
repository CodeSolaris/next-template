    ...
    <div className="animate-in fade-in slide-in-from-bottom-4 flex flex-col gap-6 duration-1000">
      <div>
        ...
        <p className="font-mono text-sm text-foreground/50">
          Sign in to your NeoDesk workspace.
        </p>
      </div>
      ...
      <form className="flex flex-col gap-4" onSubmit={e => e.preventDefault()}>
        ...
        <button className="mt-4 flex w-full items-center justify-center gap-2 rounded-xl bg-primary py-3 font-semibold text-primary-foreground shadow-[0_0_20px_rgba(123,97,255,0.3)] transition-transform hover:scale-[1.02] dark:text-white">
          Sign In
          {' '}
